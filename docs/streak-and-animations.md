...
| Metrics | aligned 2-col row `WORDS · SAVED`, thin divider, no tinted background (the streak already covers days) | — |
...
### 2.6 Settings window (`Settings/`)

No continuous animation. Sidebar selection swaps a brand-orange rounded background; panes
cross-swap with no transition (deliberate — settings should feel instant, not animated).
